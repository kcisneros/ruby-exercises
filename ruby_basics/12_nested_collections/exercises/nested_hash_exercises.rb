...
def find_beautiful_languages(languages)
  ...
  languages.select {|lan, data| data[:is_beautiful?] == true}
end
...
def find_language_facts(languages, language_name, fact_index = 0)
  ...
  # languages.collect do |lan, data|
  #   p "languages is: #{lan}, data is: #{data}, language name is: #{language_name}"
  #   data.select do |attr, val|
  #     if attr == :facts
  #       p "the fact index is: #{fact_index}, the attr is: #{attr}, the val is: #{val}"
  #       return val[fact_index]
  #   end
  # end
  # end
  ...
  # languages.each do |lan, data|
  #   data.select do |attr, val| #{|attr, val| p "attr is: #{attr}, val is #{val}"}
  #     if attr == :facts
  #       p "val is: #{val}"
  #       return val[fact_index]
  #     end
  ...
  # dug = languages.dig(language_name)
  # dug2 = dug.dig(fact_index)
  # p "using dig: #{dug}"
  # p "using dug2: #{dug2}"
